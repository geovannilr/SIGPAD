...
class GenActaEtapa2_gc extends CI_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('Pdfs_model');
        $this->load->model('PDG/GenActaEtapa2_gc_model');
    ...
    public function generar($id) {
        ...
        $pdf->SetTitle('Acta Nota Etapa 2');
        $pdf->SetSubject('Acta Nota Etapa 2');
        ...
        $datos_equipo['id']=$id;
        $resultado=$this->GenActaEtapa2_gc_model->DatosEquipo($datos_equipo);      
        ...
        $nombreDocenteAsesor=strtoupper ($this->GenActaEtapa2_gc_model->DatosDocenteAsesor($id_equipo_tg,$anio_tg,$ciclo_tg));
       ...
       // Example of Image from data stream ('PHP rules')
        ...
        $html .=    '<p>TRABAJO DE GRADUACION</p>
                    ...
                    <p style="text-align: center;">EVALUACIÓN N° 3 (25%)</p>
        ...
        $html .=    '<table border="1" style="height: 13px;" width="587">
                   ...
                   $resultadoAlumnos=$this->GenActaEtapa2_gc_model->ApellidosNombresEquipoTg($id_equipo_tg,$anio_tg,$ciclo_tg);      
                    foreach ($resultadoAlumnos->result_array() as $row)
                    {
                            ...
                            $resultadoNota=$this->GenActaEtapa2_gc_model->NotaSegunCarnet($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            if ($resultadoNota<6){
                                $a_r='R';
                            }
                            else{
        ...
        $html2 .=   '<p>TRABAJO DE GRADUACION</p>
                    <p style="text-align: center;"><strong>FORMATO DE EVALUACIÓN N° 3</strong></p>
                    <p>GRUPO N&deg;:'.$id_equipo_tg.'</p>
                   ';
        ...
        $html2  .=  '<tr style="height: 13px;">
                   ...
                   $resultadoAlumnos=$this->GenActaEtapa2_gc_model->ApellidosNombresEquipoTg($id_equipo_tg,$anio_tg,$ciclo_tg);      
                    foreach ($resultadoAlumnos->result_array() as $row)
                    {
                            ...
                            $resultadoNotaCriterio1=$this->GenActaEtapa2_gc_model->NotaCriterio1($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            $html2 .='<td style="width: 100px; height: 13px; text-align: center;">'.$resultadoNotaCriterio1.'</td>';
                            $resultadoNotaCriterio2=$this->GenActaEtapa2_gc_model->NotaCriterio2($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            $html2 .='<td style="width: 95px; height: 13px; text-align: center;">'.$resultadoNotaCriterio2.'</td>';
                            $resultadoNotaCriterio3=$this->GenActaEtapa2_gc_model->NotaCriterio3($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            $html2 .='<td style="width: 100px; height: 13px; text-align: center;">'.$resultadoNotaCriterio3.'</td>';
                            $resultadoNotaCriterio4=$this->GenActaEtapa2_gc_model->NotaCriterio4($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            $html2 .='<td style="width: 95px; height: 13px; text-align: center;">'.$resultadoNotaCriterio4.'</td>';
                            $resultadoNotaCriterio5=$this->GenActaEtapa2_gc_model->NotaCriterio5($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            $html2 .='<td style="width: 100px; height: 13px; text-align: center;">'.$resultadoNotaCriterio5.'</td>';
                            $resultadoNotaCriterio6=$this->GenActaEtapa2_gc_model->NotaCriterio6($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
                            $html2 .='<td style="width: 95px; height: 13px; text-align: center;">'.$resultadoNotaCriterio6.'</td>';
                            $resultadoNotaExposicion=$this->GenActaEtapa2_gc_model->NotaExposicion($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due);
        ...
        $html2  .= '<p>&nbsp;</p>
                    ...
                    $resultadoNotaDocumento=$this->GenActaEtapa2_gc_model->NotaDocumento($id_equipo_tg,$anio_tg,$ciclo_tg);
        ...
        $nombre_archivo = utf8_decode("Acta_de_Notas_Etapa2_equipo_".$id_equipo_tg.".pdf");
