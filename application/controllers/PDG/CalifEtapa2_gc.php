...
class CalifEtapa2_gc extends CI_Controller {
    public function __construct()
    {
        ...
        if($id_cargo_administrativo=='6' and $id_cargo == '2'){
            ...
            $this->load->model('PDG/CalifEtapa2_gc_model');
    ...
    public function _CalifEtapa2_output($output = null)
    {

        $data['output'] = $output;
        $data['contenido']='PDG/FormCalifEtapa2_gc';
    ...
    public function index()
    {
            ...
            $crud->set_table('pdg_nota_etapa2');
            //Encontrar id_equipo_tg en base al id_docente logueado
            $id_equipo_tg_filtrar_docente=$this->CalifEtapa2_gc_model->EncontrarIdEquipoFiltrarDocente($id_doc_est);               
            ...
            $crud->set_subject('Etapa 2');  
            //Definiendo las columnas  que apareceran 
            $crud->columns('id_nota_etapa2','id_equipo_tg','tema','anio_tg','ciclo_tg','id_due',
                        ...
                        'nota_exposicion','nota_etapa2');        
            //Cambiando nombre a los labels de los campos
            $crud->display_as('id_nota_etapa2','Correlativo')
            ...
            $crud->fields('id_nota_etapa2','id_equipo_tg','tema','anio_tg','ciclo_tg','id_due',
                        'estado_nota','nota_documento',
                        'cod_criterio1','nota_criterio1','cod_criterio2','nota_criterio2',   
                        'cod_criterio3','nota_criterio3','cod_criterio4','nota_criterio4',  
                        'cod_criterio5','nota_criterio5','cod_criterio5','nota_criterio6',    
            ...
            $crud->callback_edit_field('id_nota_etapa2',array($this,'idNotaEtapa2SoloLectura'));
            ...
            $crud->callback_edit_field('nota_etapa2',array($this,'notaEtapa2SoloLectura'));
            ...
            $crud->unset_delete(); 
            $crud->callback_update(array($this,'actualizacion_CalifEtapa2'));           
            $output = $crud->render();

            $this->_CalifEtapa2_output($output);
   ...
   public function checar_nota_documento($nota_documento)
    ...
    public function checar_nota_etapa2($nota_etapa2)
    {

       if(is_numeric($nota_etapa2)) 
       {
            if ($nota_etapa2 < 0 or $nota_etapa2 > 10)
            {
                $this->form_validation->set_message('checar_nota_etapa2', "La nota de la Etapa 2 debe estar entre 0 y 10");
                return FALSE;
            }
            else
            {
       ...
       {
            $this->form_validation->set_message('checar_nota_etapa2', "La nota de la Etapa 2 solo admite valores numericos");
            return FALSE;
       }
    }      
   //Edicion de solo lectura
   function idNotaEtapa2SoloLectura($value){
        return '<input class="form-control"  type="text" id="field-id_nota_etapa2" name="field-id_nota_etapa2" value="'.$value.'" readonly>';
    }   
    ...
    function codCriterio1SoloLectura($value){
            ...
            $cod_criterio=$this->CalifEtapa2_gc_model->EncuentraCriterio($var);
    ...
    function notaEtapa2SoloLectura($value){
        return '<input class="form-control" type="text" id="field-nota_etapa2" name="field-nota_etapa2" value="'.$value.'" readonly>';
    }                        

  public   function actualizacion_CalifEtapa2($post_array){                       
                     
            $update['id_nota_etapa2']=$post_array['field-id_nota_etapa2'];
            ...
            $update['nota_etapa2']=$post_array['nota_etapa2'];
           
            $comprobar=$this->CalifEtapa2_gc_model->Update($update);
            if ($comprobar >=1){
                $huboError=0;
                //return true;
            }
