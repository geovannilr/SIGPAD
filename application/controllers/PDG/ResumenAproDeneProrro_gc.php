...
class ResumenAproDeneProrro_gc extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        if  (
            ...
            $this->load->model('PDG/ResumenAproDeneProrro_gc_model');
    ...
    public function _ResumenAproDeneProrro_output($output = null)
    {

        $data['output'] = $output;
        $data['contenido']='PDG/FormResumenAproDeneProrro_gc';
    ...
    public function index()
    {
            ...
            $sql="TRUNCATE TABLE pdg_resumen_apro_dene_prorro_temp"; 
            $this->db->query($sql);
            $sql="INSERT INTO pdg_resumen_apro_dene_prorro_temp SELECT * FROM view_resum_apro_dene_prorro_pdg";
            $this->db->query($sql);
            ...
            $crud->set_table('pdg_resumen_apro_dene_prorro_temp');
           if ($tipo == 'Estudiante'){
                //Encontrar id_equipo_tg en base al id_due logueado
                $id_equipo_tg_filtrar=$this->ResumenAproDeneProrro_gc_model->EncontrarIdEquipoFiltrar($id_doc_est);            
                $crud->where('pdg_resumen_apro_dene_prorro_temp.id_equipo_tg',$id_equipo_tg_filtrar);
            }                
            ...
            $crud->set_subject('Resumen Aprobación/Denegación de Solicitud de Prorroga de TG');
           ...
           $crud->display_as('id_solicitud_academica','Id. Solicitud Académica')
            ...
            $this->_ResumenAproDeneProrro_output($output);
    }
