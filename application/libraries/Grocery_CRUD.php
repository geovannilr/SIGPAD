...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function _print_webpage($data)
	{
		...
		$string_to_print .= '
							<table style="height: 76px;" width="559">
							<tbody>
							<tr>
							<td style="width: 549px;">UNIVERSIDAD DE EL SALVADOR</td>
							</tr>
							<tr>
							<td style="width: 549px;">FACULTAD DE INGENIERIA Y ARQUITECTURA</td>
							</tr>
							<tr>
							<td style="width: 549px;">ESCUELA DE INGENIERIA DE SISTEMAS INFORMATICOS</td>
							</tr>
							</tbody>
							</table>
							<br>';		
