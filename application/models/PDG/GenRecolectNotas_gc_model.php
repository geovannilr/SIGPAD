<?php 
class GenRecolectNotas_gc_model extends CI_Model
{
	...
	function DatosEquipo($datos_equipo)
	    {
	        ...
	        $sql="SELECT id_equipo_tg,anio_tg,ciclo_tg,tema,sigla FROM pdg_recolector_notas_temp
	...
	function NotaAnteproy($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {

			$sql="SELECT nota_anteproyecto FROM  pdg_consolidado_notas
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaEtapa1($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {

			$sql="SELECT nota_etapa1 FROM  pdg_consolidado_notas
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaEtapa2($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
	...
	function NotaDefensaPublica($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {

			$sql="SELECT nota_defensa_publica FROM  pdg_consolidado_notas
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	        ...
	        foreach ($query->result_array() as $row)
	        {
	                $valor=$row['nota_defensa_publica'];
	...
	function NotaFinal($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
