<?php 
class GenActaEtapa1_gc_model extends CI_Model
{
	...
	function NotaCriterio1($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_criterio1 FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaCriterio2($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_criterio2 FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaCriterio3($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_criterio3 FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaCriterio4($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_criterio4 FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaCriterio5($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_criterio5 FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaCriterio6($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_criterio6 FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaExposicion($id_equipo_tg,$anio_tg,$ciclo_tg,$id_due)
	    {
			...
			$sql="SELECT nota_exposicion FROM pdg_nota_etapa1
					WHERE id_equipo_tg='".$id_equipo_tg."'
					AND anio_tg='".$anio_tg."'
					AND ciclo_tg='".$ciclo_tg."'
					AND id_due='".$id_due."'";
	...
	function NotaDocumento($id_equipo_tg,$anio_tg,$ciclo_tg)
	    {
			...
			$sql="SELECT DISTINCT nota_documento FROM pdg_nota_etapa1
				  WHERE id_equipo_tg='".$id_equipo_tg."'
				  AND anio_tg='".$anio_tg."'
				  AND ciclo_tg='".$ciclo_tg."'";
