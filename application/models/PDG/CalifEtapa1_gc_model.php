<?php
class CalifEtapa1_gc_model extends CI_Model{
   ...
   function EncontrarIdEquipoFiltrarDocente($id_docente){
        ...
        $sql="SELECT DISTINCT id_equipo_tg FROM pdg_nota_etapa1
  ...
  function Update($update)
    {
        ...
        //Calculo de la nota de exposicion de la etapa 1
      ...
      $nota_exposicion=$suma_nota_criterios_exposicion;
		  ...
		  //Calculo de la nota de etapa 1

   		$nota_etapa1=round((($update['nota_documento'])*0.60 + ($nota_exposicion)*0.40),2);

		//Actualizando la pdg_nota_etapa1
        $sql = "UPDATE pdg_nota_etapa1 set nota_criterio1='".$update['nota_criterio1']."',
        ...
        nota_criterio5='".$update['nota_criterio5']."',nota_criterio6='".$update['nota_criterio6']."',
    		...
    		nota_etapa1='".$nota_etapa1."'
        where id_nota_etapa1='".$update['id_nota_etapa1']."'";		
		$this->db->query($sql);
