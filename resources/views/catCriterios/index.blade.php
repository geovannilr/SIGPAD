...
<script type="text/javascript">
	$( document ).ready(function() {
		...
		<ol class="breadcrumb"  style="text-align: center; margin-top: 1em">
	        <li class="breadcrumb-item">
	          <h5><a href="{{ route('catCatalogo.index') }}" style="margin-left: 0em"><i class="fa fa-arrow-left fa-lg" style="z-index: 1;margin-top: 0em;margin-right: 0.5em; color: black"></i></a>     Criterios</h5>
	        </li>
  ...
  @can('catCriterios.create')
    <div class="col-sm-3">
      <a class="btn btn-primary" href="{{route('catCriterios.create')}}" ><i class="fa fa-plus"></i> Nuevo criterio</a>
    </div>
  @endcan
  </div> 
