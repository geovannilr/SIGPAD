...
<section  style="background-color: #ffffff; height: 100%; width: 100%;" id="listado">
        <div class="my-auto" id="seccionListado">
          ...
          <h2 class="mb-5" style="margin-top: 1em;margin-bottom: 1em;color: #212656  ; text-align: center;  font-family: 'Segoe UI'; font-size: 35px;
...
<section  style="background-color: #ffffff; height: 100%; width: 100%; " id="listado">
        <div class="my-auto" id="seccionListado2" style="">
          <span class="elementor-divider-separator"></span>
          <h2 class="mb-5" style="margin-top: 2em;margin-bottom: 1em;color: #212656  ; text-align: center;  font-family: 'Segoe UI'; font-size: 35px;
