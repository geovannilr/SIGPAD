...
CREATE TABLE `cat_cri_eva_criterio_evaluacion` (
  ...
  CONSTRAINT `fk_cat_cri_eva_criterio_evaluacion_pdg_asp_aspectos_evaluativ1` FOREIGN KEY (`id_pdg_asp`) REFERENCES `pdg_asp_aspectos_evaluativos` (`id_pdg_asp`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `cat_eta_eva_etapa_evaluativa` VALUES (10,'Anteproyecto',15.00,1,2018,1),(11,'Analisis y Diseño',25.00,1,2018,1),(12,'Codificación',50.00,1,2018,0),(13,'Defensa Final',10.00,1,2018,1),(14,'Modulo 1',25.00,1,2019,0),(15,'Modulo 2',25.00,1,2019,1),(16,'Modulo 3',25.00,1,2019,1),(17,'Modulo 4',25.00,1,2019,0);
...
CREATE TABLE `cat_ski_skill` (
  ...
  CONSTRAINT `fk_cat_ski_skill_cat_tpo_ski_tipo_skill1` FOREIGN KEY (`id_tpo_ski`) REFERENCES `cat_tpo_ski_tipo_skill` (`id_tpo_ski`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `cat_sta_estado` (
  ...
  CONSTRAINT `fk_cat_sta_estado_cat_tpo_sta_tipo_estado1` FOREIGN KEY (`id_cat_tpo_sta`) REFERENCES `cat_tpo_sta_tipo_estado` (`id_cat_tpo_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `cat_tpo_tra_gra_tipo_trabajo_graduacion` VALUES (1,'Desarrollo de Software',2018),(2,'Trabajo de Investigación',2018),(3,'Desarrollo Agil',2018),(4,'Especialización',2019);
...
CREATE TABLE `dcn_cer_certificaciones` (
  ...
  CONSTRAINT `fk_dcn_cer_certificaciones_cat_idi_idioma1` FOREIGN KEY (`id_cat_idi`) REFERENCES `cat_idi_idioma` (`id_cat_idi`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `dcn_exp_experiencia` (
  ...
  CONSTRAINT `fk_dcn_exp_experiencia_cat_idi_idioma1` FOREIGN KEY (`id_cat_idi`) REFERENCES `cat_idi_idioma` (`id_cat_idi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_dcn_exp_experiencia_pdg_dcn_docente1` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dcn_exp_ues_experiencia_ues` (
  ...
  CONSTRAINT `fk_reference_docente_experiencia` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_reference_experiencia_cargo_docente` FOREIGN KEY (`id_cat_car`) REFERENCES `cat_car_cargo_eisi` (`id_cat_car`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gen_int_integracion` (
  ...
  CONSTRAINT `fk_gen_int_integracion_gen_tpo_int_tipo_integracion1` FOREIGN KEY (`id_gen_tpo_int`) REFERENCES `gen_tpo_int_tipo_integracion` (`id_gen_tpo_int`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gen_par_parametros` (
  ...
  CONSTRAINT `fk_gen_par_parametros_gen_tpo_par_tipo_parametro1` FOREIGN KEY (`id_gen_tpo_par`) REFERENCES `gen_tpo_par_tipo_parametro` (`id_gen_tpo_par`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `gen_par_parametros` VALUES (1,'Cant. Max. Grupo','5',33,'2018-08-05 23:25:18',1),(2,'Cant. Min. Grupo ','3',33,'2018-08-05 23:25:18',1);
...
INSERT INTO `gen_usuario` VALUES (0,'Administrador de Publicaciones','admin_publicaciones','publicacione_tdg@eisi.edu.sv','$2y$10$2t6H4n4DtoVZvWbo6/rFFeM15VPs3ZnbVj7YqkPTkBX2olLGhsCTy','yKJJBFH4WLxKVoPco898Xv7erimiM6uj8XSgQxYWGUofj93ctScRA16AkvcS','2018-07-20 00:39:08','2018-07-20 00:39:08',NULL,NULL,NULL,NULL,NULL),(3,'Fernando Ernesto Cosme Morales','cm11005','cosme.92@gmail.com','$2y$10$BjPijXdO87r91PjefxJA0ODEyOjmgyyhfdr.s0YxRMH77y9vYEzJG','oHSwuFxq96JDUlqsBVLVfFJmzpsiND8zqnW4FX7oCOQmSTgdaCGOGkjI4l69','2018-04-01 21:23:31','2018-05-02 16:46:29',NULL,NULL,NULL,NULL,NULL),(20,'Francisco Wilfredo Polanco Portillo','pp10005','polanco260593@gmail.com','$2y$10$Db..R7cD93r70/TgPqYzLetuYq.U.vsseOJiiq/c3rw2WnEgY47b6',NULL,'2018-04-12 19:48:34','2018-04-12 19:48:34',NULL,NULL,NULL,NULL,NULL),(21,'Edgardo José Ramirez García','rg12001','edgardo.ramirez94@gmail.com','$2y$10$x76t/jfOKVu3ZrBFcNMzxee47YyYwmjBpHCCN0ed1zgOF8D0TneGC','XQWXV2nsqqMwTQEip8HSZdYRheN14GYvVu9EIPRaGz7HLkJonEnjHAycPipd','2018-04-12 19:49:39','2018-04-12 19:49:39',NULL,NULL,NULL,NULL,NULL),(22,'Eduardo Rafael Serrano Barrera','sb12002','rafael31194@hotmail.com','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','2aRSDvIGOxk9WWqOpOqmGkbVM5nYSdokEXkU4EkGzcB6WfhGYRtOvewwLvFL','2018-04-12 19:51:07','2018-04-12 19:51:07',NULL,NULL,NULL,NULL,NULL),(30,'Administrador Central','admin','administrador@ues.edu.sv','$2y$10$PdTVSePNsZMz/G/dT7uKM.nx4jwoCFRoU/qQntwPZQ9OtBjehYeiK','juTtwHCDufz95geyIjisbd0GVw7Zt4xPSZ6UUqtraAUz0jEcjUVmn6JgT5ub','2018-05-02 12:28:30','2018-05-02 12:28:30',NULL,NULL,NULL,NULL,NULL),(31,'Yesenia Vigil','admin_tdg','tdg@ues.edu.sv','$2y$10$lscTHMSe2IuDSIfItMXMLeEgaDUkal18L1FQjPnMWX3ErzF1EdR7C','B3sjh8qEFIGeELkBtPbHlpbUBfJkmTcfqToXXZA5FVlc86lJp1Ahz44pmzrM','2018-05-21 04:50:36','2018-05-21 04:50:36',NULL,NULL,NULL,NULL,NULL),(32,'Cesar González','cg99005','cesargrodriguez@gmail.com','$2y$10$Hq8qsxVNZ6Wh5wBcQU58Yez8o00vTg22OAylsuenZPgS48ojmOQP2',NULL,'2018-06-25 03:53:40','2018-06-25 03:53:40','Cesar','Augusto','González','Rodriguez','cg99005'),(33,'Balmore Ortiz','bo96001','balmore.ortiz@gmail.com','$2y$10$whBZB27BBTQD.BE3eBaxyev8FACIqK.uNy10kiHq21zpD/.F5mjpO',NULL,'2018-06-25 03:56:29','2018-06-25 03:56:29','Balmore',NULL,'Ortiz',NULL,'bo96001'),(34,'Yennifer Santofimio Rincón','sb12003','sb12003@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','iiL8XOqEuSHrP2PCNFIh13wKjknuJXRM0KC4zm7SVmZWHOt78s3gLnkNXPtV','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(35,'Maria Alejandra Jaramillo Rivera','sb12004','sb12004@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','6oQFACOQVokOuWxtLp4ne5wGDM1Qp5ISATGUy9YuLFx3ADPBmXRag1DFAHA4','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(36,'Maikil Steven Durango Calvo','sb12005','sb12005@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','5YdntmwgsDLXioUpBzE6zU9wTYSrkFW0Y6h1w7lqRnSrQbNv2rcpoDmOWavX','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(37,'Luisa Manuela Betancur Vargas','sb12006','sb12005@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','jWC7Wwa5Y4DrDDu6uXj4F0i5CTNKneArQyPAkaJ1CuzeXqariQ3t3gvxAG0D','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(38,'Lizeth Gallego Quiroz','sb12007','sb12006@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','M8v07XucO6QmHrxaHRnjMA22nFVB8mY4kNYUqS0VzZlYmpgGl21kHSiiUb0h','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(39,'Laura Marecla Osorio Serna','sb12008','sb12007@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','OBB1HtusDq49qxuamymtvzltjepwhjfKCLvAcwLo22yrAHsDI1o1jjFCOCLJ','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(40,'Juan Pablo Quintero Tamayo','sb12009','sb12008@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','zdPn89QXLEhCAbjX9nOZseZTErlJduYd8BS98u8FTaPABa6OWajNcbV5MMsv','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(41,'Gysela Andrea Jordan Aristizabal','sb12010','sb12009@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS','g1iVst1OgHuVrEqBaPkgEvhrEnuR1JDn0LPoYEeUmIF7nNR2VHlevUGFA1mJ','2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(42,'Gloria Estefany Velez Serna','sb12011','sb12010@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS',NULL,'2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL),(43,'Estefany Ochoa Cardona','sb12012','sb12011@ues.edu.sv','$2y$10$U4USomU1aYJmniMN0ghXZesIrpGV2laeOMF5A3DfAdHrkmZx17bIS',NULL,'2018-08-06 03:56:29',NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `pdg_apr_eta_tra_aprobador_etapa_trabajo` (
  ...
  CONSTRAINT `fk_pdg_apr_eta_tra_aprobador_etapa_trabajo_pdg_eta_eva_tra_et1` FOREIGN KEY (`id_pdg_eta_eva_tra`) REFERENCES `pdg_eta_eva_tra_etapa_trabajo` (`id_pdg_eta_eva_tra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_apr_eta_tra_aprobador_etapa_trabajo_pdg_tra_gra_trabaj1` FOREIGN KEY (`id_pdg_tra_gra`) REFERENCES `pdg_tra_gra_trabajo_graduacion` (`id_pdg_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_apr_eta_tra_aprobador_etapa_trabajo_pdg_tri_gru_tribun1` FOREIGN KEY (`id_pdg_tri_gru`) REFERENCES `pdg_tri_gru_tribunal_grupo` (`id_pdg_tri_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdg_arc_doc_archivo_documento` (
  ...
  CONSTRAINT `fk_pdg_arc_doc_archivo_documento_pdg_doc_documento1` FOREIGN KEY (`id_pdg_doc`) REFERENCES `pdg_doc_documento` (`id_pdg_doc`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `pdg_asp_aspectos_evaluativos` (
  ...
  CONSTRAINT `fk_pdg_asp_aspectos_evaluativos_cat_eta_eva_etapa_evaluativa1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `pdg_asp_aspectos_evaluativos` VALUES (1,'Documento',40.00,10),(2,'Defensa',60.00,10),(3,'Analisis',50.00,11),(4,'Diseño',50.00,11),(5,'Defensa',100.00,12),(6,'Tomo',40.00,13),(7,'Defensa Final',60.00,13);
...
CREATE TABLE `pdg_bit_tra_gra_bitacora_trabajo_graduacion` (
  ...
  CONSTRAINT `fk_pdg_bit_tra_gra_bitacora_trabajo_graduacion_pdg_tra_gra_tr1` FOREIGN KEY (`id_pdg_tra_gra`) REFERENCES `pdg_tra_gra_trabajo_graduacion` (`id_pdg_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdg_dcn_docente` (
  ...
  CONSTRAINT `fk_references_cat_cargo` FOREIGN KEY (`id_cargo_actual`) REFERENCES `cat_car_cargo_eisi` (`id_cat_car`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pdg_dcn_docente` VALUES (1,'cg99005','1999',1,32,NULL,NULL,'es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen. No sólo sobrevivió 500 años, sino que tambien ingresó como texto de relleno en documentos electrónicos, quedando esencialmente igual al original. Fue popularizado en los 60s con la creación de las hojas \"Letraset\", las cuales contenian pasajes de Lorem Ipsum, y más recientemente con software de autoedición, como por ejemplo Aldus PageMaker, el cual incluye versiones de Lorem Ipsum.',2,'https://www.facebook.com/','https://twitter.com/','https://www.linkedin.com','https://github.com/'),(2,'bo96001','1996',1,33,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'sb12010','1996',1,41,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'sb12011','1996',1,42,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'sb12012','1996',1,43,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `pdg_def_defensa` (
  ...
  CONSTRAINT `fk_pdg_def_defensa_cat_eta_eva_etapa_evaluativa1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_def_defensa_pdg_tra_gra_trabajo_graduacion1` FOREIGN KEY (`id_pdg_tra_gra`) REFERENCES `pdg_tra_gra_trabajo_graduacion` (`id_pdg_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdg_doc_documento` (
  ...
  CONSTRAINT `fk_pdg_doc_documento_cat_pdg_tpo_doc_tipo_documento1` FOREIGN KEY (`id_cat_tpo_doc`) REFERENCES `cat_tpo_doc_tipo_documento` (`id_cat_tpo_doc`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_doc_documento_pdg_gru_grupo1` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `pdg_eta_eva_tra_etapa_trabajo` (
  ...
  CONSTRAINT `fk_pdg_eta_eva_tra_etapa_trabajo_cat_eta_eva_etapa_evaluativa1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_eta_eva_tra_etapa_trabajo_pdg_tra_gra_trabajo_graduaci1` FOREIGN KEY (`id_pdg_tra_gra`) REFERENCES `pdg_tra_gra_trabajo_graduacion` (`id_pdg_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `pdg_gru_est_grupo_estudiante` (
  ...
  CONSTRAINT `fk_pdg_gru_est_grupo_estudiante_cat_sta_estado1` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_gru_est_grupo_estudiante_gen_est_estudiante1` FOREIGN KEY (`id_gen_est`) REFERENCES `gen_est_estudiante` (`id_gen_est`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_gru_est_grupo_estudiante_pdg_gru_grupo` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pdg_gru_est_grupo_estudiante` VALUES (1,1,1,6,1),(2,1,4,6,0),(4,1,2,6,0),(5,2,5,6,1),(8,2,8,6,0),(9,3,7,6,1),(10,3,9,6,0),(11,3,10,6,0),(12,3,11,6,0),(13,2,12,6,0),(14,2,13,6,0);
...
CREATE TABLE `pdg_gru_grupo` (
  ...
  CONSTRAINT `fk_pdg_gru_grupo_cat_sta_estado1` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pdg_gru_grupo` VALUES (1,3,'01-2018',1,2018,'I'),(2,3,'03-2018',3,2018,'I'),(3,3,'02-2018',2,2018,'I');
...
CREATE TABLE `pdg_not_cri_tra_nota_criterio_trabajo` (
  ...
  CONSTRAINT `fk_pdg_not_cri_tra_nota_criterio_trabajo_cat_cri_eva_criterio1` FOREIGN KEY (`id_cat_cri_eva`) REFERENCES `cat_cri_eva_criterio_evaluacion` (`id_cat_cri_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_not_cri_tra_nota_criterio_trabajo_pdg_gru_est_grupo_es1` FOREIGN KEY (`id_pdg_gru_est`) REFERENCES `pdg_gru_est_grupo_estudiante` (`id_pdg_gru_est`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdg_per_perfil` (
  ...
  CONSTRAINT `fk_pdg_per_perfil_reference_cat_ctg_categoria_tra_gra` FOREIGN KEY (`id_cat_ctg_tra`) REFERENCES `cat_ctg_tra_categoria_trabajo_graduacion` (`id_cat_ctg_tra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_per_perfil_reference_cat_sta_estado` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_per_perfil_reference_cat_tpo_tra_gra_tipo_trabajo_gra` FOREIGN KEY (`id_cat_tpo_tra_gra`) REFERENCES `cat_tpo_tra_gra_tipo_trabajo_graduacion` (`id_cat_tpo_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_per_perfil_reference_pdg_gru_grupo` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdg_ppe_pre_perfil` (
  ...
  CONSTRAINT `fk_pdg_ppe_pre_perfil_cat_sta_estado1` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_ppe_pre_perfil_cat_tpo_tra_gra_tipo_trabajo_graduacion1` FOREIGN KEY (`id_cat_tpo_tra_gra`) REFERENCES `cat_tpo_tra_gra_tipo_trabajo_graduacion` (`id_cat_tpo_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_ppe_pre_perfil_pdg_gru_grupo1` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `pdg_tra_gra_trabajo_graduacion` (
  ...
  CONSTRAINT `fk_pdg_tra_gra_trabajo_graduacion_cat_ctg_tra_categoria_traba1` FOREIGN KEY (`id_cat_ctg_tra`) REFERENCES `cat_ctg_tra_categoria_trabajo_graduacion` (`id_cat_ctg_tra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_tra_gra_trabajo_graduacion_cat_sta_estado1` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_tra_gra_trabajo_graduacion_cat_tpo_tra_gra_tipo_trabaj1` FOREIGN KEY (`id_cat_tpo_tra_gra`) REFERENCES `cat_tpo_tra_gra_tipo_trabajo_graduacion` (`id_cat_tpo_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_tra_gra_trabajo_graduacion_gru_grupo` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pdg_tri_gru_tribunal_grupo` (
  ...
  CONSTRAINT `fk_pdg_tri_gru_tribunal_grupo_pdg_dcn_docente1` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_tri_gru_tribunal_grupo_pdg_gru_grupo1` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pdg_tri_gru_tribunal_grupo_pdg_tri_rol_tribunal_rol1` FOREIGN KEY (`id_pdg_tri_rol`) REFERENCES `pdg_tri_rol_tribunal_rol` (`id_pdg_tri_rol`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `pdg_tri_gru_tribunal_grupo` VALUES (1,1,1,1),(2,3,2,1),(3,3,3,1),(4,1,2,2),(5,3,1,2),(6,3,3,2),(7,3,4,2),(8,1,3,3),(9,2,2,3),(10,3,1,3),(11,3,5,3);
...
CREATE TABLE `pub_arc_publicacion_archivo` (
  ...
  CONSTRAINT `fk_pub_arc_publicacion_archivo_pub_publicacion1` FOREIGN KEY (`id_pub`) REFERENCES `pub_publicacion` (`id_pub`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pub_arc_publicacion_archivo` VALUES (1,47,'C:\\wamp\\www\\SIGPAD\\public\\Uploads\\Publicaciones\\Codigo200407060731Portal Utec.pdf','2018-07-23 18:07:31','Portal Utec.pdf','test1','PENDIENTE',1),(3,248,'Codigo201503040833Anteproyecto.pdf','2018-08-03 16:08:33','Anteproyecto.pdf','Documento final','PENDIENTE',1),(4,247,'Codigo201502050805Anteproyecto Entrega Final.pdf','2018-08-03 17:08:05','Anteproyecto Entrega Final.pdf','*','PENDIENTE',1),(5,246,'Codigo201501060854Anteproyecto.pdf','2018-08-03 18:08:54','Anteproyecto.pdf','Anteproyecto','PENDIENTE',1);
...
CREATE TABLE `pub_aut_publicacion_autor` (
  ...
  CONSTRAINT `fk_pub_aut_publicacion_autor_gen_int_integracion1` FOREIGN KEY (`id_gen_int`) REFERENCES `gen_int_integracion` (`id_gen_int`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pub_aut_publicacion_autor_pub_publicacion1` FOREIGN KEY (`id_pub`) REFERENCES `pub_publicacion` (`id_pub`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `pub_col_colaborador` (
  ...
  CONSTRAINT `fk_pub_col_colaborador_gen_int_integracion1` FOREIGN KEY (`id_gen_int`) REFERENCES `gen_int_integracion` (`id_gen_int`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `pub_publicacion` (
  ...
  CONSTRAINT `fk_gen_pub_publicacion_cat_tpo_pub_tipo_publicacion` FOREIGN KEY (`id_cat_tpo_pub`) REFERENCES `cat_tpo_pub_tipo_publicacion` (`id_cat_tpo_pub`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_pub_publicacion_gen_int_integracion1` FOREIGN KEY (`id_gen_int`) REFERENCES `gen_int_integracion` (`id_gen_int`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `rel_col_pub_colaborador_publicacion` (
  ...
  CONSTRAINT `fk_rel_col_pub_colaborador_publicacion_cat_tpo_col_pub_tipo_c1` FOREIGN KEY (`id_cat_tpo_col_pub`) REFERENCES `cat_tpo_col_pub_tipo_colaborador` (`id_cat_tpo_col_pub`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_col_pub_colaborador_publicacion_pub_col_colaborador1` FOREIGN KEY (`id_pub_col`) REFERENCES `pub_col_colaborador` (`id_pub_col`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_col_pub_colaborador_publicacion_pub_publicacion1` FOREIGN KEY (`id_pub`) REFERENCES `pub_publicacion` (`id_pub`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_dcn_cer_docente_certificacion` (
  ...
  CONSTRAINT `fk_rel_dcn_cer_docente_certificacion_dcn_cer_certificaciones1` FOREIGN KEY (`id_dcn_cer`) REFERENCES `dcn_cer_certificaciones` (`id_dcn_cer`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_dcn_cer_docente_certificacion_pdg_dcn_docente1` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_est_pro_estudiante_proceso` (
  ...
  CONSTRAINT `fk_rel_est_pro_estudiante_proceso_cat_pro_proceso1` FOREIGN KEY (`id_cat_pro`) REFERENCES `cat_pro_proceso` (`id_cat_pro`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_est_pro_estudiante_proceso_cat_sta_estado1` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_idi_dcn_idioma_docente` (
  ...
  CONSTRAINT `fk_rel_idi_dcn_idioma_docente_cat_idi_idioma1` FOREIGN KEY (`id_cat_idi`) REFERENCES `cat_idi_idioma` (`id_cat_idi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_idi_dcn_idioma_docente_pdg_dcn_docente1` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_obs_gru_observacion_grupo` (
  ...
  CONSTRAINT `fk_rel_obs_gru_observacion_grupo_pdg_gru_grupo1` FOREIGN KEY (`id_pdg_gru`) REFERENCES `pdg_gru_grupo` (`id_pdg_gru`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_obs_gru_observacion_grupo_pdg_obs_observacion1` FOREIGN KEY (`id_pdg_obs`) REFERENCES `pdg_obs_observacion` (`id_pdg_obs`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_obs_ppe_observacion_preperfil` (
  ...
  CONSTRAINT `fk_rel_obs_ppe_observacion_preperfil_pdg_obs_observacion1` FOREIGN KEY (`id_pdg_obs`) REFERENCES `pdg_obs_observacion` (`id_pdg_obs`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_obs_ppe_observacion_preperfil_pdg_ppe_pre_perfil1` FOREIGN KEY (`id_pdg_ppe`) REFERENCES `pdg_ppe_pre_perfil` (`id_pdg_ppe`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_pdg_obs_arc_observacion_archivo` (
  ...
  CONSTRAINT `fk_rel_pdg_obs_arc_observacion_archivo_pdg_arc_doc_archivo_do1` FOREIGN KEY (`id_pdg_arc_doc`) REFERENCES `pdg_arc_doc_archivo_documento` (`id_pdg_arc_doc`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_pdg_obs_arc_observacion_archivo_pdg_obs_observacion1` FOREIGN KEY (`id_pdg_obs`) REFERENCES `pdg_obs_observacion` (`id_pdg_obs`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_rol_tri_eta_eva_tribunal_etapa` (
  ...
  CONSTRAINT `fk_rel_rol_tri_eta_eva_tribunal_etapa_cat_eta_eva_etapa_evalu1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_rol_tri_eta_eva_tribunal_etapa_pdg_tri_rol_tribunal_rol1` FOREIGN KEY (`id_pdg_tri_rol`) REFERENCES `pdg_tri_rol_tribunal_rol` (`id_pdg_tri_rol`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_ski_dcn_skill_docente` (
  ...
  CONSTRAINT `fk_rel_ski_dcn_skill_docente_cat_ski_skill1` FOREIGN KEY (`id_cat_ski`) REFERENCES `cat_ski_skill` (`id_cat_ski`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_ski_dcn_skill_docente_pdg_dcn_docente1` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `rel_sta_eta_eva_estado_etapa_evaluativa` (
  ...
  CONSTRAINT `fk_rel_sta_eta_eva_estado_etapa_evaluativa_cat_eta_eva_etapa_1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_sta_eta_eva_estado_etapa_evaluativa_cat_sta_estado1` FOREIGN KEY (`id_cat_sta`) REFERENCES `cat_sta_estado` (`id_cat_sta`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `rel_tit_dcn_titulo_docente` (
  ...
  CONSTRAINT `fk_rel_tit_dcn_titulo_docente_cat_tit_titulos_profesionales1` FOREIGN KEY (`id_cat_tit`) REFERENCES `cat_tit_titulos_profesionales` (`id_cat_tit`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_tit_dcn_titulo_docente_pdg_dcn_docente1` FOREIGN KEY (`id_pdg_dcn`) REFERENCES `pdg_dcn_docente` (`id_pdg_dcn`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_tpo_doc_eta_eva_tipo_documento_etapa_eva` (
  ...
  CONSTRAINT `fk_rel_tpo_doc_eta_eva_tipo_documento_etapa_eva_cat_eta_eva_e1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_tpo_doc_eta_eva_tipo_documento_etapa_eva_cat_pdg_tpo_d1` FOREIGN KEY (`id_cat_tpo_doc`) REFERENCES `cat_tpo_doc_tipo_documento` (`id_cat_tpo_doc`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rel_tpo_tra_eta_tipo_trabajo_etapa` (
  ...
  CONSTRAINT `fk_rel_tpo_tra_eta_tipo_trabajo_etapa_cat_eta_eva_etapa_evalu1` FOREIGN KEY (`id_cat_eta_eva`) REFERENCES `cat_eta_eva_etapa_evaluativa` (`id_cat_eta_eva`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_rel_tpo_tra_eta_tipo_trabajo_etapa_cat_tpo_tra_gra_tipo_tr1` FOREIGN KEY (`id_cat_tpo_tra_gra`) REFERENCES `cat_tpo_tra_gra_tipo_trabajo_graduacion` (`id_cat_tpo_tra_gra`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rel_tpo_tra_eta_tipo_trabajo_etapa` VALUES (1,1,10,1),(2,1,11,2),(3,1,12,3),(4,1,13,4),(5,4,14,1),(6,4,15,2),(7,4,16,3),(8,4,17,4);
...
INSERT INTO `role_user` VALUES (1,3,20,'2018-04-12 19:48:34','2018-04-12 19:48:34'),(2,3,21,'2018-04-12 19:49:39','2018-04-12 19:49:39'),(3,3,22,'2018-04-12 19:51:07','2018-04-12 19:51:07'),(6,3,25,'2018-04-23 12:10:50','2018-04-23 12:10:50'),(7,2,25,'2018-04-23 12:10:50','2018-04-23 12:10:50'),(16,3,3,'2018-04-26 22:07:18','2018-04-26 22:07:18'),(20,6,30,'2018-05-02 12:28:30','2018-05-02 12:28:30'),(21,7,31,'2018-06-12 10:07:09','2018-06-12 10:07:09'),(22,2,0,'2018-06-25 03:53:40','2018-06-25 03:53:40'),(23,0,0,'2018-07-20 00:39:08','2018-07-20 00:39:08'),(32,6,22,'2018-08-03 21:05:16','2018-08-03 21:05:16'),(34,8,22,'2018-08-03 21:05:16','2018-08-03 21:05:16'),(35,2,33,'2018-08-05 07:07:53','2018-08-05 07:07:53'),(36,2,32,'2018-08-05 07:08:18','2018-08-05 07:08:18'),(37,6,32,'2018-08-05 07:08:18','2018-08-05 07:08:18'),(38,8,32,'2018-08-05 07:08:19','2018-08-05 07:08:19'),(39,3,34,'2018-08-06 05:11:41',NULL),(40,3,35,'2018-08-06 05:11:41',NULL),(41,3,36,'2018-08-06 05:11:41',NULL),(42,3,37,'2018-08-06 05:11:41',NULL),(43,3,38,'2018-08-06 05:11:41',NULL),(44,3,39,'2018-08-06 05:11:41',NULL),(45,3,40,'2018-08-06 05:11:41',NULL),(46,3,41,'2018-08-06 05:11:41',NULL),(47,3,42,'2018-08-06 05:11:41',NULL),(48,3,43,'2018-08-06 05:11:41',NULL);
...
--
-- Dumping events for database 'sigpad_dev'
--
...
/*!50003 SET sql_mode              = 'STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_pdg_getDocumentosByEtapa`(IN `idEtapa` INT)
BEGIN

SELECT rel.id_cat_eta_eva,nombre_cat_eta_eva,ponderacion_cat_eta_eva, rel.id_tpo_doc,nombre_pdg_tpo_doc
...
BEGIN -- si se recibe -1 se debe eliminar del grupo y sin asignarlo a alguno
...
/*!50001 VIEW `view_dcn_perfildocente` AS select `dcn`.`id_pdg_dcn` AS `id_pdg_dcn`,`dcn`.`carnet_pdg_dcn` AS `carnet_pdg_dcn`,`dcn`.`anio_titulacion_pdg_dcn` AS `anio_titulacion_pdg_dcn`,`dcn`.`activo` AS `activo`,`dcn`.`id_gen_usuario` AS `id_gen_usuario`,`dcn`.`dcn_profileFoto` AS `dcn_profileFoto`,`rtit`.`id_cat_tit` AS `id_cat_tit`,`rtit`.`id_rel_tit_dcn` AS `id_rel_tit_dcn`,`tit`.`nombre_titulo_cat_tit` AS `nombre_titulo_cat_tit`,`exp`.`id_dcn_exp` AS `id_dcn_exp`,`exp`.`lugar_trabajo_dcn_exp` AS `lugar_trabajo_dcn_exp`,`exp`.`anio_inicio_dcn_exp` AS `anio_inicio_dcn_exp`,ifnull(`exp`.`anio_fin_dcn_exp`,'') AS `anio_fin_dcn_exp`,`exp`.`id_cat_idi` AS `idIdiomaExper`,`exp`.`idiomaExper` AS `idiomaExper`,`exp`.`descripcion_dcn_exp` AS `descripcionExperiencia`,`cerd`.`id_dcn_cer` AS `id_dcn_cer`,`cerd`.`id_rel_dcn_cer` AS `id_rel_dcn_cer`,`cer`.`nombre_dcn_cer` AS `nombre_dcn_cer`,`cer`.`anio_expedicion_dcn_cer` AS `anio_expedicion_dcn_cer`,`cer`.`institucion_dcn_cer` AS `institucion_dcn_cer`,`cer`.`id_cat_idi` AS `idIdiomaCert`,`cer`.`idiomaCert` AS `idiomaCert`,`rski`.`id_rel_ski_dcn` AS `id_rel_ski_dcn`,`rski`.`nivel_ski_dcn` AS `nivel_ski_dcn`,`rski`.`Nivel` AS `Nivel`,`ski`.`id_cat_ski` AS `id_cat_ski`,`ski`.`nombre_cat_ski` AS `nombre_cat_ski`,`ski`.`id_tpo_ski` AS `id_tpo_ski`,`ridi`.`id_rel_idi_dcn` AS `id_rel_idi_dcn`,`idi`.`id_cat_idi` AS `idIdioma`,`idi`.`nombre_cat_idi` AS `nombre_cat_idi` from (((((((((`sigpad_dev`.`pdg_dcn_docente` `dcn` left join `sigpad_dev`.`rel_tit_dcn_titulo_docente` `rtit` on((`rtit`.`id_pdg_dcn` = `dcn`.`id_pdg_dcn`))) left join `sigpad_dev`.`cat_tit_titulos_profesionales` `tit` on((`tit`.`id_cat_tit` = `rtit`.`id_cat_tit`))) left join (select `ex`.`id_dcn_exp` AS `id_dcn_exp`,`ex`.`lugar_trabajo_dcn_exp` AS `lugar_trabajo_dcn_exp`,`ex`.`anio_inicio_dcn_exp` AS `anio_inicio_dcn_exp`,`ex`.`anio_fin_dcn_exp` AS `anio_fin_dcn_exp`,`ex`.`descripcion_dcn_exp` AS `descripcion_dcn_exp`,`ex`.`id_cat_idi` AS `id_cat_idi`,`ex`.`id_pdg_dcn` AS `id_pdg_dcn`,`id`.`nombre_cat_idi` AS `idiomaExper` from (`sigpad_dev`.`dcn_exp_experiencia` `ex` join `sigpad_dev`.`cat_idi_idioma` `id` on((`id`.`id_cat_idi` = `ex`.`id_cat_idi`)))) `exp` on((`exp`.`id_pdg_dcn` = `dcn`.`id_pdg_dcn`))) left join `sigpad_dev`.`rel_dcn_cer_docente_certificacion` `cerd` on((`cerd`.`id_pdg_dcn` = `dcn`.`id_pdg_dcn`))) left join (select `certi`.`id_dcn_cer` AS `id_dcn_cer`,`certi`.`nombre_dcn_cer` AS `nombre_dcn_cer`,`certi`.`anio_expedicion_dcn_cer` AS `anio_expedicion_dcn_cer`,`certi`.`institucion_dcn_cer` AS `institucion_dcn_cer`,`certi`.`id_cat_idi` AS `id_cat_idi`,`id`.`nombre_cat_idi` AS `idiomaCert` from (`sigpad_dev`.`dcn_cer_certificaciones` `certi` join `sigpad_dev`.`cat_idi_idioma` `id` on((`id`.`id_cat_idi` = `certi`.`id_cat_idi`)))) `cer` on((`cer`.`id_dcn_cer` = `cerd`.`id_rel_dcn_cer`))) left join (select `skd`.`id_rel_ski_dcn` AS `id_rel_ski_dcn`,`skd`.`nivel_ski_dcn` AS `nivel_ski_dcn`,`skd`.`id_pdg_dcn` AS `id_pdg_dcn`,`skd`.`id_cat_ski` AS `id_cat_ski`,(case when (`skd`.`nivel_ski_dcn` = 1) then 'Basico' when (`skd`.`nivel_ski_dcn` = 2) then 'Intermedio' else 'Avanzado' end) AS `Nivel` from `sigpad_dev`.`rel_ski_dcn_skill_docente` `skd`) `rski` on((`rski`.`id_pdg_dcn` = `dcn`.`id_pdg_dcn`))) left join `sigpad_dev`.`cat_ski_skill` `ski` on((`ski`.`id_cat_ski` = `rski`.`id_rel_ski_dcn`))) left join `sigpad_dev`.`rel_idi_dcn_idioma_docente` `ridi` on((`ridi`.`id_pdg_dcn` = `dcn`.`id_pdg_dcn`))) left join `sigpad_dev`.`cat_idi_idioma` `idi` on((`idi`.`id_cat_idi` = `ridi`.`id_cat_idi`))) */;
...
-- Dump completed on 2018-10-09 22:19:44
