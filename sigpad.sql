...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2018 a las 01:05:46
...
ALTER TABLE `cat_estado`
  ...
  ADD KEY `fk_gen_estado_gen_tipo_estado1_idx` (`cat_tipo_estado_idcat_tipo_estado`);
...
ALTER TABLE `pdg_grupo_estudiante`
  ADD PRIMARY KEY (`gen_estudiante_idgen_estudiante`,`pdg_grupo_idpdg_grupo`),
  ADD KEY `fk_pdg_equipo_estudiante_gen_estudiante_idx` (`gen_estudiante_idgen_estudiante`),
  ADD KEY `fk_pdg_equipo_estudiante_pdg_equipo1_idx` (`pdg_grupo_idpdg_grupo`);
...
--
ALTER TABLE `gen_estudiante`
  MODIFY `idgen_estudiante` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `pdg_grupo`
  MODIFY `idpdg_grupo` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `cat_estado`
  ADD CONSTRAINT `fk_gen_estado_gen_tipo_estado1` FOREIGN KEY (`cat_tipo_estado_idcat_tipo_estado`) REFERENCES `cat_tipo_estado` (`idcat_tipo_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pdg_grupo`
--
ALTER TABLE `pdg_grupo`
  ADD CONSTRAINT `fk_pdg_equipo_gen_estado1` FOREIGN KEY (`cat_estado_idcat_estado`) REFERENCES `cat_estado` (`idcat_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `pdg_grupo_estudiante`
  ...
  ADD CONSTRAINT `fk_pdg_equipo_estudiante_pdg_equipo1` FOREIGN KEY (`pdg_grupo_idpdg_grupo`) REFERENCES `pdg_grupo` (`idpdg_grupo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
